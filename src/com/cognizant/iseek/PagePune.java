...
public class PagePune {
	...
	public static void pagePuneTest(WebDriver driver,String filepath) throws IOException, InterruptedException
	{
		try
		{	
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("//*[@id='profiles-search-wrapper']/div[4]/div/div/ul[2]/li[6]/a")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("//*[@id='profiles-search-wrapper']/div[4]/div/div/ul[2]/li[13]/a")).click();
		Thread.sleep(1000);
